...
class LoFTRMatcher:
    ...
    def prepare_data(self, cfgs, image_folder, image_pairs):
        dataset = CoarseMatchingDataset(cfgs, image_folder, image_pairs)
    ...
    def match_all_pairs(self, to_image_basename=True):
        matches = {}
